...
def run(data_params, cfg):
    ...
    plotting.plot_activity_grid(dh.construct_activity_grid(activity_arr, data_params["cur_dc_tag"], cfg), data_params, cfg)
    plotting.plot_presence_grid(dh.construct_presence_grid(activity_arr, data_params["cur_dc_tag"], cfg), data_params, cfg)
